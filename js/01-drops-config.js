    const MOB_DROPS = {
        ...
        '黑暗妖精將軍': [['scroll_acc',0.001],['scroll_armor', 0.5], ['scroll_weapon', 0.5], ['bk_reduction_armor', 0.05], ['bk_meteor', 0.001], ['bk_dark_poison', 1], ['bk_dark_burn', 1], ['bk_dark_poisonres', 1], ['bk_dark_dex', 0.6], ['bk_dark_double', 0.1], ['bk_dark_fang', 0.5], ['mat_black_blood', 1], ['mat_steel_chunk',10], ['relic_general_swordguard',0.1]],
        // ===== 魔獸訓練場 =====
        ...
        '夢幻之島地精靈王': [['arm_69', 1], ['arm_63',5], ['scroll_weapon',5], ['scroll_armor',10], ['scroll_revive',1], ['panacea_con',1], ['mat_earth_breath',1], ['relic_earthking_resist',0.1]],
        ...
        '巴土瑟': [['item_olin_diary',1],['arm_87',5], ['arm_90',10], ['arm_54',1], ['acc_117',0.01], ['amu_int',0.1], ['scroll_weapon',10], ['scroll_armor',20], ['scroll_acc',1], ['new_item_150',1], ['new_item_154',5], ['new_item_155',0.5], ['new_item_156',0.1], ['bk_cancel',0.1], ['bk_quake',0.1], ['bk_elf_groundtrap',5], ['bk_elf_earthbless',1], ['acc_119',0.1], ['acc_125',0.1], ['relic_rockmage_secret',0.1]],
        ...
        '夢幻之島水精靈王': [['arm_69', 1], ['arm_63',5], ['scroll_weapon',5], ['scroll_armor',10], ['scroll_revive',1], ['panacea_int',1], ['mat_water_breath',1], ['relic_waterking_caress',0.1]],
        ...
        '夢幻之島火精靈王': [['arm_69', 1], ['arm_63',5], ['scroll_weapon',5], ['scroll_armor',10], ['scroll_revive',1], ['panacea_str',1], ['mat_fire_breath',1], ['relic_fireking_blast',0.1]],
        ...
        '獨角獸': [['wpn_18',3], ['scroll_weapon',5], ['scroll_armor',10], ['scroll_poly',1], ['panacea_cha',1], ['mat_unicorn_horn',0.1], ['relic_pure_maiden_love',0.1]],
        ...
        '紅鬼魂': [['item_lost_soul',1],['amr_robe',3], ['glv_crystal',0.01], ['bk_elf_seal',0.05], ['bk_dark_shadow',0.1], ['item_soul_orb',0.01], ['mat_moonlight_breath', 0.01], ['relic_magic_resist_shirt',0.1]],
        ...
        '夢幻之島風精靈王': [['arm_69', 1], ['arm_63',5], ['scroll_weapon',5], ['scroll_armor',10], ['scroll_revive',1], ['panacea_dex',1], ['mat_wind_breath',1], ['relic_windking_roar',0.1]],
        ...
        '象牙塔巴列斯之影': [['mat_black_mithril',1],['wpn_powerless_baless',0.0001],['bot_baless',0.1]],
        ...
        '象牙塔巴風特之影': [['mat_black_mithril',1],['wpn_powerless_baphomet',0.0001],['amr_baphomet',0.1]],
    ...
    [
        ['妖魔', 'relic_orc_lid', 0.1],
        ['哥布林', 'relic_goblin_blade', 0.1],
        ['妖魔弓箭手', 'relic_orcarcher_bow', 0.1],
        ['地靈', 'relic_gremlin_club', 0.1],
        ['蘑菇', 'relic_mushroom_cap', 0.1],
        ['污染的地精靈', 'relic_gnomeearth_tshirt', 0.1],
        ['狼', 'relic_wolf_shawl', 0.1],
        ['哈士奇', 'relic_husky_bone', 0.1],
        ['侏儒', 'relic_dwarf_sheet', 0.1],
        ['熊', 'relic_bear_fishbone', 0.1],
        ['牧羊犬', 'relic_shepherd_boots', 0.1],
        ['人形殭屍', 'relic_zombie_shin', 0.1],
        ['杜賓狗', 'relic_doberman_fang', 0.1],
        ['安普長老', 'relic_amp_staff', 0.1],
        ['污染的安特', 'relic_ent_bark', 0.1],
        ['漂浮之眼', 'relic_eye_crystal', 0.1],
        ['妖魔鬥士', 'relic_gladiator_scimitar', 0.1],
        ['冰原狼人', 'relic_icefield_pick', 0.1],
        ['怪手', 'relic_monsterhand_skin', 0.1],
        ['狼人', 'relic_werewolf_mace', 0.1],
        ['侏儒戰士', 'relic_dwarf_chainmail', 0.1],
        ['骷髏', 'relic_weathered_skull', 0.1],
        ['妖魔殭屍', 'relic_orc_nail', 0.1],
        ['甘地妖魔', 'relic_orc_gloves', 0.1],
        ['污染的潘', 'relic_pan_staff', 0.1],
        ['鱷魚', 'relic_croc_tshirt', 0.1],
        ['冰之女王侍女', 'relic_maid_gift', 0.1],
        ['巨蟻', 'relic_giantant_antenna', 0.1],
        ['妖魔法師', 'relic_orcmage_cloth', 0.1],
        ['骷髏弓箭手', 'relic_elastic_rib', 0.1],
        ['蟑螂人', 'relic_roach_shell', 0.1],
        ['石頭高崙', 'relic_golem_fist', 0.1],
        ['羅孚妖魔', 'relic_orc_cleaver', 0.1],
        ['骷髏斧手', 'relic_strong_femur', 0.1],
        ['骷髏斧手', 'relic_forgotten_spear', 0.1],
        ['夏洛伯', 'relic_spider_claw', 0.1],
        ['妖魔巡守', 'relic_scout_scope', 0.1],
        ['哈柏哥布林', 'relic_hobgoblin_grinder', 0.1],
        ['阿吐巴妖魔', 'relic_orc_butcher', 0.1],
        ['都達瑪拉妖魔', 'relic_orc_pole', 0.1],
        ['歐熊', 'relic_bear_fur', 0.1],
        ['蜥蜴人', 'relic_lizard_shield', 0.1],
        ['穴居人', 'relic_caveman_webbing', 0.1],
        ['史巴托', 'relic_sparta_grudge', 0.1],
        ['食屍鬼', 'relic_ghoul_bracelet', 0.1],
        ['鯊魚', 'relic_shark_teeth', 0.1],
        ['黑騎士', 'relic_guard_towershield', 0.1],
        // 🏺 遺物 第二批（v3.1.1·29 件）
        ['黑騎士搜索隊', 'relic_guard_spear', 0.1],
        ['人魚', 'relic_mermaid_tear', 0.1],
        ['那魯加妖魔', 'relic_orc_loincloth', 0.1],
        ['萊肯', 'relic_crescent_earring', 0.1],
        ['楊果里恩', 'relic_ungoliant_plate', 0.1],
        ['蟹人', 'relic_crab_claw', 0.1],
        ['狂野之毒', 'relic_wild_mane_coat', 0.1],
        ['狂野毒牙', 'relic_venom_fang', 0.1],
        ['歐姆', 'relic_ohm_shackle', 0.1],
        ['巨大兵蟻', 'relic_soldierant_carapace', 0.1],
        ['鼠人', 'relic_ratman_skewer', 0.1],
        ['海星', 'relic_starfish_arm', 0.1],
        ['遺忘之島鱷魚', 'relic_croc_soul', 0.1],
        ['遺忘之島蜥蜴人', 'relic_lizard_scale', 0.1],
        ['狂暴蜥蜴人', 'relic_veteran_lizard_gauntlet', 0.1],
        ['狂野之魔', 'relic_black_gale', 0.1],
        ['長老', 'relic_elder_thunder', 0.1],
        ['卡司特', 'relic_green_imp_nail', 0.1],
        ['狂暴的歐姆', 'relic_ohm_hidepants', 0.1],
        ['食人妖精', 'relic_ogre_mawashi', 0.1],
        ['蛇女', 'relic_lamia_tailscale', 0.1],
        ['魔蝙蝠', 'relic_bat_wing', 0.1],
        ['底比斯 曼陀羅草(白)', 'relic_mandra_spirit', 0.1],
        ['歐姆裝甲兵', 'relic_ohm_heavyarmor', 0.1],
        ['地獄犬', 'relic_cerberus_wand', 0.1],
        ['希爾黛斯', 'relic_watersprite_string', 0.1],
        ['龍龜', 'relic_dragonturtle_shell', 0.1],
        ['藍尾蜥蜴', 'relic_bluetail_tail', 0.1],
        ['重裝蜥蜴人', 'relic_lizardman_cleaver', 0.1],
        // 🏺 遺物 第三批（v3.1.2·19 件）
        ['狂暴的歐姆裝甲兵', 'relic_ohm_maul', 0.1],
        ['闇之精靈', 'relic_darkspirit_shroud', 0.1],
        ['犰狳', 'relic_armadillo_helm', 0.1],
        ['白螞蟻群', 'relic_whiteant_shell', 0.1],
        ['高等蜥蜴人', 'relic_high_lizard_armguard', 0.1],
        ['奇異鸚鵡', 'relic_parrot_beak', 0.1],
        ['海賊骷髏', 'relic_pirate_scimitar', 0.1],
        ['毒蠍', 'relic_scorpion_sting', 0.1],
        ['哈維', 'relic_harvey_claw', 0.1],
        ['底比斯 曼陀羅草', 'relic_death_leaf', 0.1],
        ['黑暗妖精魔法學徒', 'relic_apprentice_wand', 0.1],
        ['魔熊', 'relic_bear_vitality', 0.1],
        ['歐姆民兵', 'relic_militia_armor', 0.1],
        ['骷髏神射手', 'relic_sharpshooter_bow', 0.1],
        ['骷髏警衛', 'relic_guard_pike', 0.1],
        ['黑暗精靈', 'relic_whirlwind_xbow', 0.1],
        ['黑暗妖精殘兵(弓)', 'relic_darkremnant_boots', 0.1],
        ['歐吉', 'relic_ogi_greataxe', 0.1],
        ['多羅', 'relic_doro_vitality', 0.1],
        // 🏺 遺物 第四批（v3.1.4）
        ['伊萊克頓', 'relic_deepfish_skin', 0.1],
        ['強盜', 'relic_bandit_token', 0.1],
        ['雪人', 'relic_yeti_fist', 0.1],
        ['雪人', 'arm_yeti_gloves', 0.01],   // 一般防具 雪人手套（非遺物·0.01%）
        ['紙人', 'relic_paper_cloak', 0.1],
        ['黑暗妖精盜賊', 'relic_darkthief_claw', 0.1],
        ['闇精靈王', 'relic_darkelf_chainsword', 0.1],
        ['海賊骷髏士兵', 'relic_seawater_shirt', 0.1],
        ['骷髏鬥士', 'relic_fighter_axe', 0.1],
        ['奎斯坦修', 'relic_hermitcrab_shell', 0.1],
        ['爆彈花', 'relic_bombflower_core', 0.1],
        ['底比斯 聖甲蟲', 'relic_scarab_shin', 0.1],
        ['黑暗妖精殘兵(劍)', 'relic_darkelf_grindblade', 0.1],
        ['黑暗妖精殘兵(十字弓)', 'relic_darkelf_shootglove', 0.1],
        ['巨人', 'relic_giant_clubfrag', 0.1],
        ['食人妖精王', 'relic_ogreking_collar', 0.1],
        ['莫妮亞', 'relic_monia_sandals', 0.1],
        ['艾爾摩士兵', 'relic_wornout_underwear', 0.1],
        ['夢幻之島蘑菇', 'relic_dream_mushroom_soul', 0.1],
        // 🏺 遺物 第六批（v3.1.13·11 件）
        ['夢幻之島鬼火', 'relic_wisp_remnant', 0.1],
        ['冰人', 'relic_frostdeath_breath', 0.1],
        ['黑暗妖精殘兵(法師)', 'relic_remnant_barrier', 0.1],
        ['喚獸師', 'relic_summoner_whip', 0.1],
        ['金屬蜈蚣', 'relic_metalshell_shin', 0.1],
        ['格利芬', 'relic_griffin_claw', 0.1],
        ['艾爾摩法師', 'relic_wither_amulet', 0.1],
        ['密密', 'relic_stalker_chest', 0.1],
        ['強化巨蟻', 'relic_giantant_eye', 0.1],
        ['巨大鱷魚', 'relic_croc_fang', 0.1],
        ['冰石高崙', 'relic_icestone_maul', 0.1],
        ['底比斯 聖甲蟲(藍)', 'relic_scarab_nest', 0.1],   // 🏺 v3.1.16：聖甲蟲的孵育巢（aggroHide 迴避仇恨盾）
        // 🏺 遺物 第七批（v3.1.18·17 件）
        ['黑法師', 'relic_blackmage_pants', 0.1],
        ['變種蛇女', 'relic_mutant_lamia_scale', 0.1],
        ['海賊骷髏刀手', 'relic_pirate_bandana', 0.1],
        ['海賊骷髏首領', 'relic_pirate_ring', 0.1],
        ['巨人戰士', 'relic_giant_toothpick', 0.1],
        ['巨人長老', 'relic_giant_throwstone', 0.1],
        ['卡司特王', 'relic_redimp_nail', 0.1],
        ['活鎧甲', 'relic_armor_spareblade', 0.1],
        ['多眼怪', 'relic_beholder_gaze', 0.1],
        ['龍蠅', 'relic_fly_curse', 0.1],
        ['冰原老虎', 'relic_whitetiger_coat', 0.1],
        ['雪怪', 'relic_yeti_foot', 0.1],
        ['變形怪', 'relic_shapeshifter_underwear', 0.1],
        ['黑暗妖精殘兵(雙手劍)', 'relic_veteran_greatsword', 0.1],
        ['變種楊果里恩', 'relic_thorn_needle', 0.1],
        ['黑暗棲林者', 'relic_thorn_curse', 0.1],
        ['亞力安', 'relic_cockatrice_gaze', 0.1],
        // 🏺 遺物 第八批（v3.1.21·3 件）
        ['遺忘之島狼人', 'relic_moonhowl_helm', 0.1],
        ['遺忘之島夏洛伯', 'relic_poison_vial', 0.1],
        ['強化白螞蟻群', 'relic_ant_incubessence', 0.1],
        // 🏺 遺物 第九批（v3.1.28·10 件）
        ['阿魯巴', 'relic_aruba_haste', 0.1],
        ['火焰戰士', 'relic_ashwarrior_flamesword', 0.1],
        ['艾爾摩將軍', 'relic_deadgeneral_greatsword', 0.1],
        ['鋼鐵高崙', 'relic_steel_bulwark', 0.1],
        ['強盜頭目', 'relic_raider_belt', 0.1],
        ['底比斯 凱比斯(黑)', 'relic_darkscorpion_pincers', 0.1],
        ['遺忘之島黑暗精靈', 'relic_forgotten_sniperbow', 0.1],
        ['遺忘之島歐熊', 'relic_arrowfur_cloak', 0.1],
        ['邪惡蜥蜴', 'relic_evillizard_eye', 0.1],
        ['火焰弓箭手', 'relic_flamearcher_bracer', 0.1],   // 🏺 烈焰射手的護腕：spec 掉落源寫成物品名·取同義同級的 火焰弓箭手(fire_archer)
        // 🏺 遺物 第十批（v3.1.32·5 件）
        ['黑暗妖精警衛(十字弓)', 'relic_modded_crossbow', 0.1],
        ['梅杜莎', 'relic_medusa_stinger', 0.1],
        ['遺忘之島卡司特', 'relic_silent_venom', 0.1],
        ['思克巴', 'relic_charm_heart', 0.1],
        ['死亡之劍', 'relic_swordsman_underwear', 0.1],
        // 🏺 遺物 第十一批（v3.1.33·5 件）
        ['恐怖的火炎蛋', 'relic_fireegg_orb', 0.1],
        ['遺忘之島蛇女', 'relic_venom_avatar', 0.1],
        ['遺忘之島萊肯', 'relic_lycan_swiftlegs', 0.1],
        ['遺忘之島巨斧牛人', 'relic_axetaurus_brutalaxe', 0.1],
        ['遺忘之島食人妖精', 'relic_troll_belly', 0.1],
        // 🏺 遺物 第五批新增（v3.1.52·19 件）
        ['炎魔的思克巴', 'relic_burning_love', 0.1],
        ['巨大突擊螞蟻', 'relic_fearless_charge', 0.1],
        ['火蜥蜴', 'relic_lizard_tongue', 0.1],
        ['夢幻之島火蜥蜴', 'relic_flame_avatar', 0.1],
        ['夢幻之島殺人蜂', 'relic_killerbee_sting', 0.1],
        ['夢幻之島暴走兔', 'relic_runaway_carrot', 0.1],
        ['夢幻之島冰人', 'relic_frost_avatar', 0.1],
        ['黑暗妖精巡守', 'relic_handy_quiver', 0.1],
        ['黑暗妖精士兵', 'relic_soldier_medal', 0.1],
        ['邪惡密密', 'relic_evilchest_relic', 0.1],
        ['遺忘之島楊果里恩', 'relic_ancient_spider_claw', 0.1],
        ['火炎蛋', 'relic_flame_belt', 0.1],
        ['夢幻之島閃電球', 'relic_thunder_crown', 0.1],
        ['夢幻之島鎧甲守衛', 'relic_guardian_greatsword', 0.1],
        ['夢幻之島火炎蛋', 'relic_dream_flamesoul', 0.1],
        ['夢幻之島冰石高崙', 'relic_frost_stone_shield', 0.1],
        ['底比斯 凱比斯(紅)', 'relic_redscorpion_ring', 0.1],
        ['奇美拉', 'relic_cerberus_horn', 0.1],
        ['邪惡多眼怪', 'relic_lightbeam_wand', 0.1],
        // 🐍 蛇神降臨·提卡爾：寶箱碎片(初級 上/下·高級 上/下)/時空裂痕碎片 10%/龍騎士書板/祭壇鑰匙 2% + 遺物 0.0001%
        ['提卡爾艾庫阿茲特', 'mat_kukulkan_basic_up', 5], ['提卡爾艾庫阿茲特', 'mat_rift_shard', 10], ['提卡爾艾庫阿茲特', 'bk_dragon_awaken_falion', 0.5], ['提卡爾艾庫阿茲特', 'relic_azt_mirror', 0.1],
        ['提卡爾艾庫阿茲特(黃)', 'mat_kukulkan_basic_down', 5], ['提卡爾艾庫阿茲特(黃)', 'mat_rift_shard', 10], ['提卡爾艾庫阿茲特(黃)', 'relic_azt_prism', 0.1],
        ['提卡爾艾庫尤卡(藍)', 'mat_kukulkan_basic_up', 5], ['提卡爾艾庫尤卡(藍)', 'mat_rift_shard', 10], ['提卡爾艾庫尤卡(藍)', 'relic_yuka_blowdart', 0.1],
        ['提卡爾艾庫尤卡(白)', 'mat_kukulkan_basic_down', 5], ['提卡爾艾庫尤卡(白)', 'mat_rift_shard', 10], ['提卡爾艾庫尤卡(白)', 'relic_yuka_quiver', 0.1],
        ['提卡爾艾庫卡伊拉(藍)', 'mat_kukulkan_basic_up', 5], ['提卡爾艾庫卡伊拉(藍)', 'bk_dragon_awaken_antares', 0.5], ['提卡爾艾庫卡伊拉(藍)', 'mat_rift_shard', 10], ['提卡爾艾庫卡伊拉(藍)', 'relic_kaira_fang', 0.1],
        ['提卡爾艾庫卡伊拉(黃)', 'mat_kukulkan_basic_down', 5], ['提卡爾艾庫卡伊拉(黃)', 'bk_dragon_awaken_antares', 0.5], ['提卡爾艾庫卡伊拉(黃)', 'mat_rift_shard', 10], ['提卡爾艾庫卡伊拉(黃)', 'relic_kaira_hood', 0.1],
        ['提卡爾艾庫巴拉', 'mat_kukulkan_basic_up', 5], ['提卡爾艾庫巴拉', 'mat_rift_shard', 10], ['提卡爾艾庫巴拉', 'relic_bara_wing', 0.1],
        ['提卡爾艾庫巴拉(紅)', 'mat_kukulkan_basic_down', 5], ['提卡爾艾庫巴拉(紅)', 'mem_cube_quake', 0.5], ['提卡爾艾庫巴拉(紅)', 'mat_rift_shard', 10], ['提卡爾艾庫巴拉(紅)', 'relic_bara_eye', 0.1],
        ['提卡爾艾庫艾托', 'mat_kukulkan_basic_up', 5], ['提卡爾艾庫艾托', 'bk_dragon_lavabolt', 0.5], ['提卡爾艾庫艾托', 'mat_rift_shard', 10], ['提卡爾艾庫艾托', 'relic_eto_whip', 0.1],
        ['提卡爾艾庫艾托(枯竭)', 'mat_kukulkan_basic_down', 5], ['提卡爾艾庫艾托(枯竭)', 'bk_dragon_lavabolt', 0.5], ['提卡爾艾庫艾托(枯竭)', 'mat_rift_shard', 10], ['提卡爾艾庫艾托(枯竭)', 'relic_eto_wand', 0.1],
        ['提卡爾薩德泥偶', 'mat_kukulkan_high_up', 5], ['提卡爾薩德泥偶', 'item_tikal_altar_key', 2], ['提卡爾薩德泥偶', 'mat_rift_shard', 10], ['提卡爾薩德泥偶', 'relic_mud_idol', 0.1],
        ['提卡爾薩德泥偶(黑)', 'mat_kukulkan_high_down', 5], ['提卡爾薩德泥偶(黑)', 'item_tikal_altar_key', 2], ['提卡爾薩德泥偶(黑)', 'mat_rift_shard', 10], ['提卡爾薩德泥偶(黑)', 'relic_mud_jar', 0.1],
        ['提卡爾薩德司卡(紫)', 'mat_kukulkan_high_up', 5], ['提卡爾薩德司卡(紫)', 'item_tikal_altar_key', 2], ['提卡爾薩德司卡(紫)', 'mat_rift_shard', 10], ['提卡爾薩德司卡(紫)', 'relic_ska_soul', 0.1],
        ['提卡爾薩德司卡(紅)', 'mat_kukulkan_high_down', 5], ['提卡爾薩德司卡(紅)', 'item_tikal_altar_key', 2], ['提卡爾薩德司卡(紅)', 'mat_rift_shard', 10], ['提卡爾薩德司卡(紅)', 'relic_ska_armguard', 0.1],
        ['提卡爾薩德提歐(藍)', 'mat_kukulkan_high_up', 5], ['提卡爾薩德提歐(藍)', 'item_tikal_altar_key', 2], ['提卡爾薩德提歐(藍)', 'bk_dragon_deathlightning', 0.5], ['提卡爾薩德提歐(藍)', 'mat_rift_shard', 10], ['提卡爾薩德提歐(藍)', 'relic_teo_hammer', 0.1],
        ['提卡爾薩德提歐(黃)', 'mat_kukulkan_high_down', 5], ['提卡爾薩德提歐(黃)', 'item_tikal_altar_key', 2], ['提卡爾薩德提歐(黃)', 'bk_dragon_deathlightning', 0.5], ['提卡爾薩德提歐(黃)', 'mat_rift_shard', 10], ['提卡爾薩德提歐(黃)', 'relic_teo_footprint', 0.1],
        ['提卡爾杰弗雷庫(雄)', 'amu_str', 8], ['提卡爾杰弗雷庫(雄)', 'acc_120', 8], ['提卡爾杰弗雷庫(雄)', 'amu_int', 8], ['提卡爾杰弗雷庫(雄)', 'acc_122', 8], ['提卡爾杰弗雷庫(雄)', 'acc_121', 8], ['提卡爾杰弗雷庫(雄)', 'amu_cha', 8], ['提卡爾杰弗雷庫(雄)', 'acc_demonbane', 10], ['提卡爾杰弗雷庫(雄)', 'rng_mr', 25], ['提卡爾杰弗雷庫(雄)', 'acc_117', 5], ['提卡爾杰弗雷庫(雄)', 'acc_summon_ctrl', 5], ['提卡爾杰弗雷庫(雄)', 'acc_116', 5], ['提卡爾杰弗雷庫(雄)', 'mat_tikal_fang', 3], ['提卡爾杰弗雷庫(雄)', 'mat_tikal_eye', 3], ['提卡爾杰弗雷庫(雄)', 'scroll_armor', 30], ['提卡爾杰弗雷庫(雄)', 'scroll_weapon', 30], ['提卡爾杰弗雷庫(雄)', 'item_kukulkan_box_high', 100], ['提卡爾杰弗雷庫(雄)', 'mat_crack_core', 100], ['提卡爾杰弗雷庫(雄)', 'relic_serpent_fang', 0.1],
        ...
        ['殘暴的骷髏斧兵', 'relic_executor_axe', 0.1],
        ['殘暴的骷髏槍兵', 'relic_executor_skewer', 0.1],
        ['獨眼巨人', 'relic_jack_sling', 0.1],
        ['夢魘', 'relic_endless_nightmare', 0.1],
        ['夢幻之島大鬼火', 'relic_dullahan_ember', 0.1],
        ['黑暗妖精警衛(矛)', 'relic_guard_roughgloves', 0.1],
        ['黑虎', 'relic_blacktiger_whip', 0.1],
        ['地獄束縛犬', 'relic_hellhound_chain', 0.1],
        ['拉斯塔巴德守門人', 'relic_gatekeeper_boots', 0.1],
        ['黑暗妖精法師', 'relic_dark_manaball', 0.1],
        ['魔狼', 'relic_blackmane_coat', 0.1],
        ['恐怖夢魘', 'relic_wearying_dream', 0.1],
        ['地之牙', 'relic_earthfang_core', 0.1],
        ['風之牙', 'relic_windfang_breeze', 0.1],
        ['水之牙', 'relic_waterfang_tear', 0.1],
        ['火之牙', 'relic_firefang_ember', 0.1],
        ['馴獸師', 'relic_tamer_dogclub', 0.1],
        ['巨大強化白螞蟻', 'relic_healer_wand', 0.1],
        ['思克巴女皇', 'relic_succubus_temptation', 0.1],
        ['影魔', 'relic_shadow_stinger', 0.1],
        ['底比斯 尖碑石奴', 'relic_weathered_obelisk', 0.1],
        ['魂騎士', 'relic_soulreaper_dual', 0.1],
        ['遺忘之島格利芬', 'relic_griffin_feather', 0.1],
        ['遺忘之島鏈鎚牛人', 'relic_minotaur_flail', 0.1],
        ['遺忘之島哈維', 'relic_vigor_belt', 0.1],
...
const WARRIOR_DROPS = {
    ...
    '石頭高崙': [['bk_warrior_armorbody',0.1]], '熔岩高崙': [['bk_warrior_armorbody',0.01]],
    // 狂暴
...
[['遺忘之島巨大牛人','relic_maze_demon_glare'],['拉斯塔巴德近衛隊','relic_lining_chainshirt'],['冷酷冰原老虎','relic_icefang_armguard'],
 ...
 ['曼波兔','relic_treasured_carrot'],['墳墓守護者騎士','relic_cross_tombshield'],['象牙塔紙人','relic_mage_scrap_note']].forEach(r => (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], 0.1]));
...
[['象牙塔石頭高崙','relic_golem_lifemark'],['象牙塔密密','relic_serrated_fangs'],['克特','relic_kurt_shield'],
 ...
 ['卡魯塔','relic_ghost_teardrop'],['卡瑞','relic_true_dragonslayer'],['死亡騎士','relic_flame_dk_sword']].forEach(r => (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], 0.1]));
...
[['底比斯 尼荷斯(藍)','relic_sky_god_avatar'],['死亡的司祭(思克巴)','relic_necro_book']]
    .forEach(r => (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], 0.1]));
