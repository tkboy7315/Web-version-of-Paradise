...
(function () {
  ...
  function renderCraft() {
    ...
    // 🏛️ 歐西里斯寶箱 & 🐍 庫庫爾坎寶箱：補充製作分頁未列出的開啟機制與掉落池
    html += '<div class="m-wiki-sub">🏛️ 歐西里斯寶箱（底比斯）／🐍 庫庫爾坎寶箱（提卡爾）</div>';
    html += '<div class="m-wiki-desc" style="margin-top:4px;">';
    html += '上鎖的歐西里斯／庫庫爾坎寶箱由對應的「上＋下碎片」在<b>希培利亞村莊・巴特爾</b>處合成（已列在上方巴特爾配方中）。';
    html += '開啟需消耗<b>龜裂之核</b>（亦在巴特爾處以「時空裂痕碎片 ×100」製作），每個寶箱消耗 1 顆。';
    html += '碎片由底比斯／提卡爾區域怪物掉落（上碎片：該圖普通怪 5%、下碎片：該圖菁英怪 5%）。';
    html += '</div>';
    html += wCard('🏛️ 歐西里斯寶箱 掉落內容',
      '<div class="m-wiki-desc">・<b>初級寶箱</b>（<span class="text-amber-200">上鎖的歐西里斯初級寶箱</span>）：</div>' +
      wTbl(['物品', '初級機率', '高級機率'], [
        [wDexLink('底比斯歐西里斯雙手劍'), '0.25%', '0.75%'],
        [wDexLink('底比斯歐西里斯雙刀'), '0.25%', '0.75%'],
        [wDexLink('底比斯歐西里斯弓'), '0.25%', '0.75%'],
        [wDexLink('底比斯歐西里斯魔杖'), '0.25%', '0.75%'],
        ['武卷／防卷', '3%／4%', '4%／5%'],
        ['鑽石／綠寶石／紅寶石／藍寶石', '各 15%', '各 14%'],
        ['品質鑽石／品質綠寶石／品質紅寶石／品質藍寶石', '各 8%', '各 8%']
      ]) +
      '<div class="m-wiki-desc" style="margin-top:6px;">・四把傳說武器皆內建「<b>惡魔之吻</b>」：攻擊時 4% 機率發動 3D20 地屬性魔法傷害。腰帶與戒指不在寶箱內，為頭目（阿努比斯／賀洛斯）專屬掉落。</div>' +
      '<div class="m-wiki-desc">・<b>高級寶箱</b>（<span class="text-amber-300">上鎖的歐西里斯高級寶箱</span>）：傳說武器機率提升至 0.75%，卷軸稍增、寶石略減。</div>'
    );
    html += wCard('🐍 庫庫爾坎寶箱 掉落內容',
      '<div class="m-wiki-desc">・<b>初級寶箱</b>（<span class="text-amber-200">上鎖的庫庫爾坎初級寶箱</span>）：</div>' +
      wTbl(['物品', '初級機率', '高級機率'], [
        [wDexLink('提卡爾庫庫爾坎之矛'), '0.25%', '0.75%'],
        [wDexLink('提卡爾庫庫爾坎鐵手甲'), '0.25%', '0.75%'],
        [wDexLink('提卡爾庫庫爾坎之盾'), '0.25%', '0.75%'],
        [wDexLink('提卡爾庫庫爾坎面具'), '0.25%', '0.75%'],
        ['武卷／防卷', '3%／4%', '4%／5%'],
        ['鑽石／綠寶石／紅寶石／藍寶石', '各 15%', '各 14%'],
        ['品質鑽石／品質綠寶石／品質紅寶石／品質藍寶石', '各 8%', '各 8%']
      ]) +
      '<div class="m-wiki-desc" style="margin-top:6px;">・四件傳說裝備內建「<b>詛咒稻草人</b>」：攻擊命中 4% 機率疊加（矛／鐵手甲限定，面具／之盾無此特效）。庫庫爾坎祭壇（純 BOSS 房）鑰匙由提卡爾尼荷斯掉落。</div>' +
      '<div class="m-wiki-desc">・<b>高級寶箱</b>（<span class="text-amber-300">上鎖的庫庫爾坎高級寶箱</span>）：傳說裝備機率提升至 0.75%。</div>'
    );
    return html;
  }
